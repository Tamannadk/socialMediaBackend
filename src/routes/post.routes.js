...
router.route("/update-post/:postId").post(
    verifyJWT,
    upload.fields([
      { name: 'newImages', maxCount: 10 },  // Allow up to 10 new images
      { name: 'imagePathsToRemove', maxCount: 10 }  // Allow up to 10 image paths to remove
    ]),
    updatePost
  );
